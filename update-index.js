    ...
    <div class="container">
        <div class="intro-inner">
            <div class="reveal-up">
                ...
                <p class="intro-body">FreshField connects customers directly with local farmers, helping you discover fresh produce while giving farmers a better way to reach buyers. No unnecessary steps, no hidden costs — just real food and real relationships.</p>
                ...
                <div class="how-steps">
                    ...
                    <div class="how-step">
                        ...
                        <div class="how-step-content">
                            ...
                            <p class="how-step-desc">Get fresh produce delivered directly from the source — as nature intended.</p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="container">
        <div class="farmer-story-inner">
            ...
            <div class="farmer-story-content reveal-up delay-2">
                ...
                <p class="farmer-story-quote">"I have been farming this land for twenty years. FreshField gave me a way to reach families directly — people who care about where their food comes from, just as much as I do."</p>
...
<section id="final-cta" aria-labelledby="cta-heading">
    <div class="cta-bg-deco cta-bg-deco-1" aria-hidden="true">🌿</div>
    <div class="cta-bg-deco cta-bg-deco-2" aria-hidden="true">🌿</div>
...
// FALLBACK DEMO PRODUCTS (used when backend API is unavailable or returns no data)
...
async function loadFeaturedProducts(){
    ...
    try{
        ...
        // Backend API offline / network error — seamlessly load demo products without error UI
        renderProducts(grid,FALLBACK_PRODUCTS);
    }
    setupScrollReveal();
}
...
fs.writeFileSync('C:/farmer-marketplace/client/index.html', indexHtml, 'utf8');
console.log('Successfully updated C:/farmer-marketplace/client/index.html with fallback products!');
